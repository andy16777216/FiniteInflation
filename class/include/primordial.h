...
struct primordial {
  ...
  double k_c; /**< cutoff for power spectrum at low k ANDY */
  double alpha_exp; /**< exponent determining the sharpness of the cutoff for power spectrum at low k ANDY */
  ...
  double ** cutoff;   /**< all cutoffs in matrix form: running[index_md][index_ic1_ic2] ANDY */
  double ** exponent;   /**< all exponents in matrix form: running[index_md][index_ic1_ic2] ANDY */

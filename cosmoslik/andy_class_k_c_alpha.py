...
class main(SlikPlugin):
    ...
    def __init__(self):
        ...
        self.cosmo = get_plugin('models.cosmology')(
            logA = param(3.2),
            ns = param(0.96),
            k_c = param(0.0006,min=0,scale=0.0003),
            alpha_exp = param(3.35,min=0,scale=1),
            ombh2 = param(0.0221),
            omch2 = param(0.12),
            ...
            #k_c = param(6e-4,min=0,gaussian_prior=(6e-4,6e-3),
            #alpha_exp = param(3.35,min=0,gaussian_prior=(3.35,1)
        )
	...
	#print 'loading sampler'
        self.sampler = get_plugin('samplers.metropolis_hastings')(
             self,
             num_samples=100000,
             output_file='chains/camspec_lowl.lcdm_k_c_alpha_exp_100000.chain',
